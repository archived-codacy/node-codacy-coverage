    ...
    module.exports = {
        getCommitId: function (commitId) {
            ...
            process.nextTick(function () {
                ...
                gitCommit = gitCommit || process.env.TRAVIS_COMMIT || process.env.DRONE_COMMIT || process.env.GIT_COMMIT
                || process.env.CIRCLE_SHA1 || process.env.CI_COMMIT_ID || process.env.WERCKER_GIT_COMMIT;
